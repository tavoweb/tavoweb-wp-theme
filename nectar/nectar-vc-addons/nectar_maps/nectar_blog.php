		...
		return array(
		  ...
		  "params" => array(
			...
			array(
			  ...
			  "admin_label" => false,
			  "value" => array(
			  		 __('Inherit from Theme Options', tavoweb) => 'inherit',
						 __('Material Style', tavoweb) => 'material',
				     __('Classic Style', tavoweb) => 'classic',
             __('Classic Enhanced Style', tavoweb) => 'classic_enhanced',
             __('Meta Overlaid Style', tavoweb) => 'meta_overlaid',
						 __('Auto Masonry: Meta Overlaid Spaced', tavoweb) => 'auto_meta_overlaid_spaced'
				),
			  'save_always' => true,
			...
			array(
			  ...
			  "value" => array(
			  	   __('4px', tavoweb) => '4px',
			  		 __('8px', tavoweb) => '8px',
             __('12px', tavoweb) => '12px',
						 __('16px', tavoweb) => '16px',
						 __('20px', tavoweb) => '20px',
				),
			  'save_always' => true,
			...
			array(
			  ...
			  "value" => array(
			  	   __('Inherit from Theme Options', tavoweb) => 'inherit',
			  		 __('Classic Style', tavoweb) => 'classic',
             __('Minimal Style', tavoweb) => 'minimal',
						 __('Featured Image Left Style', tavoweb) => 'featured_img_left',
				),
			  'save_always' => true,
