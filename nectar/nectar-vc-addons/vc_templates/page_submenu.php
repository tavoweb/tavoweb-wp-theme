...
echo '<a href="#" class="mobile-menu-link"><i class="salient-page-submenu-icon"></i>'.__('Menu',tavoweb).'</a><ul  style="background-color:'.$bg_color.'; color: '.$link_color.';" >'.do_shortcode($content).'</ul>';
