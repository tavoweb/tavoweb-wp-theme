	...
	vc_map( array(
		...
		'params' => array(
			...
			array(
				...
				"group" => "Shape Divider",
				"options" => array(
					"curve" => array( __('Curve', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/curve_down.jpg"),
					'fan' => array( __('Fan', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/fan.jpg"),
					'curve_opacity' => array( __('Curve Opacity', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/curve_opacity.jpg"),
					"mountains" => array( __('Mountains', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/mountains.jpg"),
					'curve_asym' => array( __('Curve Asym.', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/curve_asym.jpg"),
					'curve_asym_2' => array( __('Curve Asym. Alt', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/curve_asym_2.jpg"),
					"tilt" => array( __('Tilt', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/tilt.jpg"),
					"tilt_alt" => array( __('Tilt Alt', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/tilt_alt.jpg"),
					"triangle" => array( __('Triangle', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/triangle.jpg"),
					'waves' => array( __('Waves', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/waves_no_opacity.jpg"),
					'waves_opacity' => array( __('Waves Opacity', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/waves.jpg"),
					'waves_opacity_alt' => array( __('Waves Opacity 2', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/waves_opacity.jpg"),
					'clouds' => array( __('Clouds', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/clouds.jpg"),
					"speech" => array( __('Speech', tavoweb) => $nectar_get_template_directory_uri."/nectar/nectar-vc-addons/img/shape_dividers/speech.jpg")
				),
			),
			array(
				"type" => "colorpicker",
  ...
  //sidebar
	...
	vc_add_param("vc_gallery",array(
	      ...
	      "value" => array(
	         ...
	         __("Touch Enabled & Spaced (Flickity)", "js_composer") => "flickity_style",
	         __("Image Grid Style", "js_composer") => "image_grid",
	         __("Parallax Image Grid", "js_composer") => "parallax_image_grid"
	       ),
	      'save_always' => true,
	...
	vc_add_param("vc_gallery",array(
		  "type" => "dropdown",
		  "heading" => __("Desktop Columns", "js_composer"),
	...
	vc_add_param("vc_gallery",array(
		  "type" => "dropdown",
		  "heading" => __("Small Desktop Columns", "js_composer"),
	...
	vc_add_param("vc_gallery",array(
	 ...
	 vc_add_param("vc_gallery",array(
	      "type" => 'checkbox',
	      "heading" => __("Free Scroll", "js_composer"),
	      "param_name" => "flickity_free_scroll",
	      "description" => __("Enables content to be freely flicked without aligning cells to an end position.", "js_composer"),
	  ...
	  vc_add_param("vc_gallery",array(
	      "type" => 'checkbox',
	      "heading" => __("Enable Auto Play", "js_composer"),
	      "param_name" => "flickity_autoplay",
	      "description" => __("Will cause your images to auto play until user interaction", "js_composer"),
	      "value" => Array(__("Yes, please", "js_composer") => 'true'),
	      "dependency" => Array('element' => "type", 'value' => array('flickity_style'))
	  ));
	  ...
	  vc_add_param("vc_gallery",array(
	      "type" => 'textfield',
	      "heading" => __("Auto Play Duration", "js_composer"),
	      "param_name" => "flickity_autoplay_dur",
	      "description" => __("Enter a custom duration in milliseconds between auto play advances e.g. 5000", "js_composer"),
	      "dependency" => Array('element' => "type", 'value' => array('flickity_style'))
	  ));
