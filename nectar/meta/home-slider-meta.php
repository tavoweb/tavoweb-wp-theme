...
function nectar_metabox_home_slider(){
    ...
    $meta_box = array(
		...
		'description' => __('If you want a full width header with background image, please fill out the fields below.', tavoweb),
		...
		'fields' => array(
			array( 
					...
					'desc' => __('The image should be between 1600px - 2000px in width and have a minimum height of 700px for best results. Click the "Upload" button to begin uploading your image, followed by "Select File" once you have made your selection.', tavoweb),
			...
			array( 
					...
					'desc' => __('Enter in the slide caption. (should be fairly short)', tavoweb),
			...
			array( 
					...
					'desc' => __('If you would like a button to appear below your caption, please enter the text for it here.', tavoweb),
			...
			array( 
					...
					'desc' => __('Please enter the URL for the button here.', tavoweb),
					'id' => '_nectar_slider_button_url',
					'type' => 'text',
					'std' => ''
				),
			array( 
					'name' => __('Slide Alignment', tavoweb),
					'desc' => __('Select the alignment for your caption and button.', tavoweb),
    ...
    $meta_box = array(
		...
		'title' => __('Slide Video Settings', tavoweb),
		'description' => __('If you want to feature a video in this slide, please fill out the fields below. <strong>Your video & image should be in a 16:9 aspect ratio.</strong>', tavoweb),
		'post_type' => 'home_slider',
		'context' => 'normal',
		'priority' => 'high',
		'fields' => array(
			array( 
					'name' => __('M4V File URL', tavoweb),
					'desc' => __('Please upload the .m4v video file. <br/><strong>You must include both formats.</strong>', tavoweb),
			...
			array( 
					...
					'desc' => __('Please upload the .ogv video file  <br/><strong>You must include both formats.</strong>', tavoweb),
