...
function nectar_metabox_portfolio(){
	...
	$meta_box = array(
		...
		'title' =>  __('Extra Content', tavoweb),
		'description' => __('Please use this section to place any extra content you would like to appear in the main content area under your portfolio item. (The above default editor is only used to populate your items sidebar content)', tavoweb),
		'post_type' => 'portfolio',
		'context' => 'normal',
		'priority' => 'high',
		'fields' => array(
	...
	if ( floatval(get_bloginfo('version')) < "3.6" ) {
		$meta_box = array(
			...
			'title' =>  __('Project Configuration', tavoweb),
			'description' => __('', tavoweb),
			'post_type' => 'portfolio',
			'context' => 'normal',
			'priority' => 'high',
			'fields' => array(
				array( 
						'name' => __('Full Width Portfolio Item Layout', tavoweb),
						'desc' => __('This will remove the sidebar and allow you to use fullwidth sections and sliders', tavoweb),
	    		...
	    		array( 
					'name' => __('Custom Thumbnail Image', tavoweb),
					'desc' => __('If you would like to have a separate thumbnail for your portfolio item, upload it here. If left blank, a cropped version of your featured image will be automatically used instead. The recommended dimensions are 600px by 403px.', tavoweb),
					'id' => '_nectar_portfolio_custom_thumbnail',
					'type' => 'file',
					'std' => ''
				),
				array(
					'name' =>  __('Hide Featured Image/Video on Single Project Page?', tavoweb),
					'desc' => __('You can choose to hide your featured image/video from automatically displaying on the top of the main project page.', tavoweb),
				...
				array( 
					'name' => __('Masonry Content Position', tavoweb),
					'desc' => __('This will only be used on project styles which show the content overlaid before hover', tavoweb),
				...
				array( 
					'name' => __('External Project URL', tavoweb),
					'desc' => __('If you would like your project to link to a custom location, enter it here (remember to include "http://")', tavoweb),
					'id' => '_nectar_external_project_url',
					'type' => 'text',
					'std' => ''
				),
				array( 
					'name' => __('Parent Portfolio Override', tavoweb),
					'desc' => __('This allows you to manually assign where your "Back to all" button will take the user on your single portfolio item pages.', tavoweb),
				...
				array( 
					'name' => __('Project Excerpt', tavoweb),
					'desc' => __('If you would like your project to display a small excerpt of text under the title in portfolio element, enter it here.', tavoweb),
	...
	//wp 3.6+
		...
		if($post) {
			...
			if(!empty($using_gallery_slider) && $using_gallery_slider == 'on'){
				$gallery_slider = array(
						...
						'desc' => __('This will turn all default WordPress galleries attached to this post into a simple slider.', tavoweb),
		...
		$meta_box = array(
			...
			'fields' => array(
				...
				array( 
						'name' => __('Custom Content Grid Item', tavoweb),
						'desc' => __('This will all you to place custom content using the above editor that will appear in your portfolio grid. By using this option the single project page will be disabled, however you can still link the item to a custom URL if desired.', tavoweb),
				...
				array( 
					'name' => __('Custom Content Grid Item Content', tavoweb),
					'desc' => __('Use this to populate what will display as your project content in place of the default meta info', tavoweb),
				...
				array( 
					'name' => __('Project Accent Color', tavoweb),
					'desc' => __('This will be used in applicable project styles in the portfolio thumbnail view.', tavoweb),
					'id' => '_nectar_project_accent_color',
					'type' => 'color',
					'std' => ''
				),
				array( 
					'name' => __('Project Title Color', tavoweb),
					'desc' => __('This will be used in applicable project styles in the portfolio thumbnail view.', tavoweb),
				...
				array( 
					'name' => __('Project Date/Custom excerpt Color', tavoweb),
					'desc' => __('This will be used in applicable project styles in the portfolio thumbnail view.', tavoweb),
				...
				array( 
					'name' => __('Custom CSS Class Name', tavoweb),
					'desc' => __('For advanced users with css knowledge - use this to add an a specific class onto your project that can be used to target it in any portfolio element to add custom styling.', tavoweb),
					'id' => '_nectar_project_css_class',
					'type' => 'text',
					'std' => ''
				),
				/*array( 
					'name' => __('3D Parallax Images', tavoweb),
    ...
    $meta_box = array(
		...
		'title' => __('Project Header Settings', tavoweb),
		...
		'fields' => array(
			...
			array( 
					...
					'desc' => __('Please choose how you would like your image background to be aligned', tavoweb),
    ...
    $meta_box = array( 
		...
		'title' => __('Video Settings', tavoweb),
		'description' => __('If you have a video, please fill out the fields below.', tavoweb),
		'post_type' => 'portfolio',
		'context' => 'normal',
		'priority' => 'high',
		'fields' => array(
			array( 
					...
					'desc' => __('Please upload the .mp4 video file.', tavoweb),
			...
			array( 
					'name' => __('Video Height', tavoweb),
					'desc' => __('This only needs to be filled out if your self hosted video is not in a 16:9 aspect ratio. Enter your height based on an 845px width. This is used to calculate the iframe height for the "Watch Video" link. <br/> <strong>Don\'t include "px" in the string. e.g. 480</strong>', tavoweb),
			...
			array(
					...
					'desc' => __('If the video is an embed rather than self hosted, enter in a Youtube or Vimeo embed code here. The width should be a minimum of 670px with any height.', tavoweb),
