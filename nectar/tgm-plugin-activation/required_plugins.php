...
function nectar_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
            'name'          => 'Admin TW', // The plugin name
            'slug'          => 'admin-tw', // The plugin slug (typically the folder name)
            'source'            => get_template_directory() . '/plugins/admin-tw.zip', // The plugin source
