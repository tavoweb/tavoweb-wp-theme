...
<div class="container-wrap">
	...
	<div class="container main-content" data-col-num="cols-<?php echo $cols; ?>">
		...
		<div id="portfolio" class="row portfolio-items <?php if($masonry_layout == 'true') echo 'masonry-items'; else { echo 'no-masonry'; } ?> <?php echo $infinite_scroll_class; ?>"  data-categories-to-show="" data-starting-filter=""  data-gutter="<?php echo $item_spacing; ?>" data-masonry-type="<?php echo $masonry_sizing_type; ?>" data-ps="<?php echo $project_style; ?>" data-col-num="<?php echo $cols; ?>">
			<?php 
								...
								<div class="work-info"> 
									...
									<div class="vert-center">
										...
										//image
									       ...
									       echo '<a href="'. $featured_image[0].'" class="default-link pretty_photo" >'.__("View Larger", tavoweb).'</a> ';
									    }
							 ...
							 $custom_thumbnail_id = fjarrett_get_attachment_id_from_url($custom_thumbnail); 
								...
								if ( has_post_thumbnail() ) {
									...
									if(!empty($image_src)) $image_src = $image_src[0];
											...
											$project_featured_img = '<img class="size-'.$masonry_item_sizing.'" src="'.$image_src.'" alt="'.$wp_img_alt_tag.'" height="'.$image_height.'" width="'.$image_width.'" />';
